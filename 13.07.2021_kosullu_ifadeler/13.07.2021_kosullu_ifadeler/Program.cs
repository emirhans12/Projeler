...
namespace _13._07._2021_kosullu_ifadeler
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            if (!cikis)
            {
                ...
                double dogruSayi1 = 0;
                if (!double.TryParse(sayi1, out dogruSayi1))
                {
                ...
                double dogruSayi2 = 0;
                if (!double.TryParse(sayi2, out dogruSayi2))
                {
                    Console.Write("Bu geçerli bir sayı değil. Lütfen bir tamsayı giriniz. ");
                    sayi2 = Console.ReadLine();
                }
                ...
                try
                {
                    sonuc = Program.islemYap(dogruSayi2, dogruSayi1, op);
